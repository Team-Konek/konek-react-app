...
export default class PieGraph extends PureComponent {
  ...
  render() {
    return (
      <ResponsiveContainer width="100%" height={200} style={{textAlign: 'center'}}>
        <PieChart width={400} height={400}>
          <Pie data={data01} dataKey="value" cx="50%" cy="50%" outerRadius={40} fill="#8884d8" />
          <Pie data={data02} dataKey="value" cx="50%" cy="50%" innerRadius={40} outerRadius={70} fill="#82ca9d" label />
        </PieChart>
      </ResponsiveContainer>
    );
  }
